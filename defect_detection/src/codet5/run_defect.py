...
def main():
    ...
    if args.do_train:
        ...
        train_examples, train_data = load_and_cache_defect_data(args, args.train_dir, pool, tokenizer, 'train',
                                                                is_sample=False)
        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(bar):
                ...
                if (step + 1) % save_steps == 0 and args.do_eval:
                    ...
                    eval_examples, eval_data = load_and_cache_defect_data(args, args.valid_dir, pool, tokenizer,
                    ...
                    if eval_acc > best_acc:
                        ...
                        output_dir = os.path.join(args.output_dir, f'checkpoint-best-acc-{args.attack_type}')
    ...
    if args.do_test:
        ...
        for criteria in ['best-acc']:
            ...
            eval_examples, eval_data = load_and_cache_defect_data(args, args.test_dir, pool, tokenizer, 'test',
                                                                  False)
